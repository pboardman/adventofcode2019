...
console.log("Findest intersection with the less steps")
let shortestPath;
for (i in intersections) {
    if (intersections[i] < shortestPath || ! shortestPath) shortestPath = intersections[i];
}
